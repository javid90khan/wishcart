...
$mail->Port = 587;
$mail->Username = 'ecard.wishcart@gmail.com';
$mail->Password = '13579qwerty';
$mail->SMTPAuth = true;

$mail->From = 'ecard.wishcart@gmail.com';
$mail->FromName = $from;
$mail->AddAddress($to);
$mail->AddReplyTo('ecard.wishcart@gmail.com', 'Information');
$mail->AddEmbeddedImage("$filename", "logoimg", "Ecard.jpg"); // attachment
//$mail->IsHTML(true);
$mail->Subject    = "E-Card From WishCart Sent to you by $from";
$mail->AltBody    = "To view the message, please use an HTML compatible email viewer!";
$mail->Body    = "<h1>E-Card From WishCart Sent to you by $from</h1><p><img src=\"cid:logoimg\" /></p>";

if(!$mail->Send())
{
  echo "Failed To send the mail. Please Try Again: " . $mail->ErrorInfo;
}
else
{
 echo '<h3><img src = "images/success.png"/></h3><h3>Congratulations! Your E-Card was succesfully sent!</h3><META HTTP-EQUIV="refresh" CONTENT="2;URL=index.php">';
